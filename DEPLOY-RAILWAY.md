...
| Login `vendedor@autofinance.pro` / `vend123` | Entra sin 2FA (usuario demo) |
| Login `soporte@autofinance.pro` / `soporte123` | Entra sin 2FA (usuario demo) |
| Login usuario nuevo (creado por Administrador) | Pide código OTP por email |
